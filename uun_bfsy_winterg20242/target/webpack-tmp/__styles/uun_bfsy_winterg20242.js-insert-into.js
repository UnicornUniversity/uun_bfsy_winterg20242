function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "uun_bfsy_winterg20242/uun_bfsy_winterg20242@0.1.0");
  styleEl.setAttribute("data-emotion", "uunbfsywinterg");
  styleEl.setAttribute("data-tech", "less");

  // insert the style element
  // 1. after last matching data-emotion using technology "less"
  var els = insertionEl.querySelectorAll(`style[data-emotion="uunbfsywinterg"]`);
